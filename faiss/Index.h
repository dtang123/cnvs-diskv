...
struct Index {
    ...
    // control function adjustReplica, and decide whether assign a code to another centroid
    float replicas_control = 1.15; 
    ...
    void set_replicas_control(float replica_dis){
        this->replicas_control = replica_dis;
    }
