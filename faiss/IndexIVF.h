...
// TODO:  for scanner to work on disk
enum Load_Strategy { FULLY, PARTIALLY };
...
struct IndexIVF : Index, IndexIVFInterface {
    ...
    // set replicas needed when building, default is 1.
    void set_assign_replicas(int k){
...
struct InvertedListScanner {
    ...
    /// TODO Only used when need to access disk.
    Load_Strategy load_strategy = FULLY;

    /// TODO set a new strategy
    void set_strategy(Load_Strategy strategy) {
